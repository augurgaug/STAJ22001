...
const Sidebar = ({ onClick }) => {
  return (
    <div className="sidebar">
      ...
      <Button  className='sidebar-button' onClick={() => onClick('musteri-list')} label="Müşteri Listesi"><FontAwesomeIcon className='icon' icon={faClipboard} /></Button>
      <Button  className='sidebar-button' onClick={() => onClick('musteri')} label="Müşteri Kayıt "><FontAwesomeIcon className='icon' icon={faUser} /> </Button>
